                        ...
                        <div>
                            <Row style={{background: product.secondaryColor}} className='py-5'>
                                ...
                                <Col sm={12} md={2} lg={2} className='float-right mt-4'>
                                    <a href={product.websiteUrl}><i className="fas fa-external-link-alt"/> Website</a>
                                </Col>
                            </Row>
                            ...
                            <Row>
                                <Col>
                                    ...
                                    <ListGroup variant='flush'>
                                        {product.features.map((review) => (
                                            <ListGroup.Item key={review.id}>
                                                <Row>
                                                    <Col>
                                                        <strong className='font-weight-bold'>{review.name}</strong>
                                                        <p><span>Feature Request</span> <span>Planned</span></p>
                                                    </Col>
                                                    <Col>
                                                        <span className='text-center'>145</span><br/>
